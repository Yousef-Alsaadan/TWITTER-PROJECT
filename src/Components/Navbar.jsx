...
function Navbar() {
  ...
  return (
    <div className="hidden md:block xl:static absolute">
      <div className="text-[#E7E9EA] flex flex-col gap-4 justify-between pb-2 h-screen xl:w-1/5 text-xl pl-4 xl:pl-0 fixed top-0 left-0 xl:left-auto">
        <div className="">
          <Link to="/">
          ...
          <div className="hover:bg-[#181919] rounded-full p-3 w-fit flex items-center gap-4 cursor-pointer">
            ...
            <h1 className="pr-2 xl:block hidden">Premium</h1>
          </div>
          ...
          <div className="hover:bg-[#181919] rounded-full p-3 w-fit flex items-center gap-4 cursor-pointer">
            ...
            <h1 className="pr-2 xl:block hidden">Business</h1>
          </div>
          ...
          <Link to="/profile">
            <div className="hover:bg-[#181919] rounded-full p-3 w-fit flex items-center gap-4">
              ...
              <h1 className="pr-2 xl:block hidden">Profile</h1>
            </div>
          </Link>
          ...
          <div className="hover:bg-[#181919] rounded-full p-3 w-fit flex items-center gap-4 cursor-pointer">
            ...
            <h1 className="pr-2 xl:block hidden">More</h1>
          </div>
        ...
        <div className="dropdown dropdown-top">
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content bg-black box_shadow rounded-box z-[1] my-3 w-56 px-0 py-3 ml-8"
          >
