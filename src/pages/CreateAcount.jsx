  ...
  return (
    <div>
      <div className="bg-[#242D34] h-screen w-screen flex justify-center items-center roboto_serif">
        <div className="bg-black lg:h-[80%] lg:w-[35%] w-full h-full rounded-2xl p-4 flex flex-col items-center gap-8">
          <div className="">
            <svg
              viewBox="0 0 24 24"
              aria-label="X"
            ...
            <div className="flex flex-col justify-between h-full items-center">
              ...
              <div className="w-full">
                ...
                <p className="text-center mt-2 text-sm text-[#71767B]">
                  ...
                  <Link className="text-[#1A89D4] hover:underline" to="/signin">
                    Log in
                  </Link>
                </p>
              </div>
